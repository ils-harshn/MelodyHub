...
from songs.serializers import SongSerializer, ArtistSerializer, SongDetailWithoutAritistSerializer, AlbumSerializer
from rest_framework.pagination import PageNumberPagination
from django_filters.rest_framework import DjangoFilterBackend
from songs.filters import SongFilterSet, ArtistFilterSet, AlbumFilterSet
...
class ArtistWithSongsView(RetrieveAPIView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        paginated_objects = paginator.paginate_queryset(related_objects, request)

        serialized_related_objects = SongDetailWithoutAritistSerializer(paginated_objects, many=True).data
...
class AlbumWithSongsView(RetrieveAPIView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        serialized_related_objects = SongSerializer(paginated_objects, many=True).data
