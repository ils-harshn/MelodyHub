...
urlpatterns = [
    ...
    path('random/song/', view=views.GetRandomSong.as_view(), name="get-random-song"),
    ...
    path('songs/neutral/', view=views.DislikedSongsListView.as_view(), name="neutralize-songs-reaction"),
