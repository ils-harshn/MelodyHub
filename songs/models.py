...
class Album(models.Model):
    ...
    thumbnail300x300 = models.CharField(max_length=254)
...
class Artist(models.Model):
    ...
    artists_thumbnail = models.CharField(max_length=254)
    artists_thumbnail300x300 = models.CharField(max_length=254)
