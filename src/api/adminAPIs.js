...
export const createAlbumAPI = (
  ...
  thumbnail300x300,
  thumbnail1200x1200,
  github_download_url300x300="",
  github_download_url1200x1200=""
) => {
  let data = new FormData();
  data.append("code", code);
  data.append("title", title);
  data.append("year", year);
  data.append("prev1_thumbnail", thumbnail1200x1200);
  data.append("prev1_thumbnail300x300", thumbnail300x300);

  data.append("thumbnail", github_download_url1200x1200);
  data.append("thumbnail300x300", github_download_url300x300);
...
export const createArtistAPI = (
  ...
  data.append("prev1_artists_thumbnail300x300", thumbnail300x300);
  data.append("prev1_artists_thumbnail", thumbnail1200x1200);
  
  data.append("artists_thumbnail300x300", github_download_url300x300);
  data.append("artists_thumbnail", github_download_url1200x1200);
